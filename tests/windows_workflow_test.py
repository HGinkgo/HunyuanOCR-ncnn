...
def main() -> int:
    ...
    required = (
        ...
        "--no-tests=error",
        "precise_sdpa|multimodal_rope|utf8|dflash_runtime|decoder_microbench_parser|text_decoder_aux|cli_options|package_model|memory_lifecycle|kv_cache_lifecycle",
